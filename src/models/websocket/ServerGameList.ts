...
export class ServerGameListConverter extends AbstractConverter {
    ...
    public assembly(data: ServerGameList)
    {
        ...
        data.games.forEach( element => dataBuffer.putByteArray(new Uint8Array(gameListGameConverter.assembly(element))), this);
...
class GameListGameConverter
{
    public assembly(data: GameListGame)
    {
        ...
        data.players.forEach(element => dataBuffer.putByteArray(new Uint8Array(gameListPlayerConverter.assembly(element))), this);
