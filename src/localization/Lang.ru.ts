...
export type LanguageKey = keyof LanguageRepository;
...
const LanguageData = {
  ...
  siteErrorCatch: "На сайте произошла ошибка. Проверьте интернет соединение, обвините страницу или обратитесь к администратору",
  ...
  createGameConfirmPatchNotificationsAccessDenied: "У вас отсуствуют права парсить конфиги. Выберите другую версию с готовым конфигом.",
  ...
  mapInfoPlayersCount: "Кол-во игроков: {count}",
  ...
  uploadMapMapUploadedNotificationDescription: "Карта {name} загружена. Кликните по уведомлению, чтобы перейти к карте.",
  ...
  mapEditPageFlagsNotification: "Данные флаги влияют на поведение объекта карты. Обратите внимание, что тег уникален и не может задан для не верефицированных карт.",
  mapEditPageFlagsLoading: "Флаги загружаются",
  mapEditPageExtraDescriptionLabel: "Дополнительное описание",
  mapEditPageExtraDescriptionNotification: "Вы в тексте можете использовать разметку Markdown. Старайтесь указывать уникальную информацию о карте.",
  ...
  mapStatusIconSemanticHint: "Скрипт карты содержит семантические ошибки. Возможно карта эксплуатирует уязвимости игры",

  prepareUploadMapModalHeader:"Выберите карту",
  prepareUploadMapModalSubHeader:"Какую карту загрузить?",
  prepareUploadMapModalDescription:"Укажите путь до w3x карты. Обычно карты находятся в папке maps которая находится там где Warcraft III.",
  ...
  createAutohostModalNotification: "Бот будет автоматически создавать игры с настроенным автостартом. Один автохост создает одно лобби.",
  ...
  accessListModalExpireNotification:"Не пугайся, бро. Отображается дата истечения ближайшего доната. Как только он истечет - дата обновится.",
  ...
  registerAccountModalDescription: "Вы с данного акканта входите впервые. Выполнить регистрацию аккаунта с помощью данного способа входа? В будущем вы не сможете отвязать аккаунт социальной сети от аккаунта бота.",
  ...
  forbiddenPage:"У вас нет доступа к этой странице. Попробуйте войти на сайт через:",
  ...
  editConfigPageNotificationDescription: "Большая часть параметров предоставлена только для ознакомления. При редактировании учитывайте особенности версии. Конфиг был создан для версии **{configData?.version}**",
  ...
  createGameConfirmPageGameCreateErrorToastDescription:"Ошибка получения параметров карты",
  ...
  autopayPageIncorrectConnectorIdNotificationDescription:"Неверно введен ID коннектора. Ведите числа напротив # в настройках на сайте",
  ...
  autopayPageHelpNotification:"Если вы подключаете автохост впервые - напишите в группу ВК ",
  ...
  replayMainInfo_2: "Имя игры:",
  replayMainInfo_3: "Версия:",
  replayMainInfo_4: "Продолжительность:",
  replayMainInfo_5: "Хост:",
