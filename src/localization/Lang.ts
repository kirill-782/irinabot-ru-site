...
export const LanguageData = {
    ...
    adminListPageTitle: "Админ лист",
    adminListPageCreateNewList: "Создать новый список",
    adminListPageRoles: "Роли",
    adminListPageAssignments: "Назначения",
    adminListPageAssignRole: "Назначить роль",
    adminListPageRemove: "Удалить",
    adminListPageActiveUntil: "Активен до",
    adminListPageItemsActiveUntil: "Элементы активны до",
    adminListPageForever: "Бесконечно",
    adminListPageDefault: "(По умолчанию)",
    adminListPagePermissions: "Разрешения",
    adminListPageUser: "Пользователь",
    adminListPageRole: "Роль",
    adminListPageModalCreateHeader: "Создать админ список",
    adminListPageModalCreateNameLabel: "Название",
    adminListPageModalCreateParentLabel: "Родительский список",
    adminListPageModalCreateParentPlaceholder: "Выберите родителя",
    adminListPageModalCreateCancel: "Отмена",
    adminListPageModalCreateCreate: "Создать",
    adminListPageModalAssignHeader: "Назначить роль",
    adminListPageModalAssignUserLabel: "Пользователь",
    adminListPageModalAssignUserPlaceholder: "Выберите пользователя",
    adminListPageModalAssignRoleLabel: "Роль",
    adminListPageModalAssignRolePlaceholder: "Выберите роль",
    adminListPageModalAssignCancel: "Отмена",
    adminListPageModalAssignAssign: "Назначить",
    adminListPageToastCreated: "Админ список создан",
    adminListPageToastAssigned: "Роль назначена",
    adminListPageToastRemoved: "Назначение удалено",
    ...
    utilsDropdownAdminList: "Список администраторов",
    adminListPageCreateListModalTitle: "Создать список",
    adminListPageCreateListName: "Название списка",
    adminListPageCreateListParent: "Родительский список",
    adminListPageAssignRoleModalTitle: "Назначить роль",
    adminListPageAssignRoleList: "Список",
    adminListPageAssignRoleUser: "Пользователь",
    adminListPageAssignRoleRole: "Роль",
    adminListPageAssignRoleAssign: "Назначить",
    adminListPageRemoveAssignment: "Удалить назначение",
    adminListPagePowerMetricWarning: "Нельзя назначить роль пользователю с более высоким показателем силы",
} as const;
