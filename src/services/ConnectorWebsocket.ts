...
export interface ConnectorWebsocket {
    addEventListener(event: "package", callback: (data: ConnectorPackageEvent) => void): void;
    addEventListener(event: "message", callback: (data: ConnectorMessageEvent) => void): void;
    addEventListener(event: "open", callback: (data: Event) => void): void;
    addEventListener(event: "close", callback: (data: Event) => void): void;

    removeEventListener(event: "package", callback: (data: ConnectorPackageEvent) => void): void;
    removeEventListener(event: "message", callback: (data: ConnectorMessageEvent) => void): void;
