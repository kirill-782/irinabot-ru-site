...
export interface MapUploaderService {
    addEventListener(event: "start", callback: (data: UploadMapStartEvent) => void): void;
    addEventListener(event: "complete", callback: (data: UploadMapCompleteEvent) => void): void;
    addEventListener(event: "progress", callback: (data: UploadMapProgressEvent) => void): void;

    removeEventListener(event: "start", callback: (data: UploadMapStartEvent) => void): void;
    removeEventListener(event: "complete", callback: (data: UploadMapCompleteEvent) => void): void;
    removeEventListener(event: "progress", callback: (data: UploadMapProgressEvent) => void): void;
}
