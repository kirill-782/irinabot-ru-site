...
function UploadMap() {
    ...
    const [currentUpload, setCurrentUpload] = useState<CurrentMapUploadDescription>({
        fillename: "",
        totalSize: 1,
        loadedSize: 0,
    });
                ...
                toast(
                    {
                        ...
                        description: t("uploadMapMapUploadedNotificationDescription", {
                            name: event.detail.map.mapInfo?.name,
                        }),
                        type: "success",
                        time: 10000,
                    },
    ...
    const onMapSelected = (files: FileList, flags: Flags, additionalFlags: AdditionalFlags) => {
        ...
        if (isMapUploading)
            return (
                <ProgressUploadMapModal
                    percent={Math.round((currentUpload.loadedSize / currentUpload.totalSize) * 100)}
