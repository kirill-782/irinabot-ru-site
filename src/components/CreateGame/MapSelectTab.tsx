...
function MapSelectTab() {
    ...
    useEffect(() => {
        const savedState = SessionStorage.get<SesstionSaveOptions>(location.key, SESSION_KEY);
        ...
        <Grid columns="equal" stackable className="map-select-tab">
            <Grid.Column width={3}>
                ...
                <Form className="filter-form">
                    <MapFilters value={searchOptions} autoCommit onFitlerChange={setSearchOptions} />
                </Form>
            </Grid.Column>
            <Grid.Column>
                <Grid.Row>
                ...
                {searchedMaps && !isFull && (
                    <Grid textAlign="center">
                        ...
                        >
                            {isLoading ? lang.loadingDotted : lang.loadMore}
                        </button>
                    </Grid>
                )}
            </Grid.Column>
