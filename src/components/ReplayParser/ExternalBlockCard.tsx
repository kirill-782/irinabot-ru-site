        ...
        <>
            ...
            >
                <Card.Content>
                    ...
                    <Card.Description>
                        {actionsBlock.errorMessage && <Message error>{actionsBlock.errorMessage}</Message>}
                                ...
                                {actionsBlock.commandBlocks.map((i, k) => {
                                    return (
                                        <React.Fragment key={k}>
                                            <Label>
                                                <LanguageKey
                                                    stringId={"externalBlockCardPlayerSummaryLabel"}
                                                    count={i.actions.length}
                                                    name={getPlayerName(i.playerId)}
                                                />
                                            </Label>
