...
import { Button, Container, Form, Grid, Header, Icon, Message, Progress } from "semantic-ui-react";
        ...
        <Container className="open-replay">
            <div className="centerd">
                <Grid>
                    ...
                    {xhr.current && (
                        <Grid.Row centered>
                            <Progress style={{ width: "35vw" }} active indicating percent={progress}></Progress>
                        </Grid.Row>
                    )}
                    <Grid.Row centered>
