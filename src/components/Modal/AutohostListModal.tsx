            ...
            <Modal.Content>
                {autohosts === null ? (
                    ...
                    <Table celled>
                        <Table.Header>
                            <Table.Row>
                                <Table.HeaderCell width={9}>{lang.autohostListModalNameHeader}</Table.HeaderCell>
                                <Table.HeaderCell width={2}>{lang.autohostListModalAutostartHeader}</Table.HeaderCell>
                                <Table.HeaderCell width={2}>{lang.autohostListModalGameLimitHeader}</Table.HeaderCell>
                                <Table.HeaderCell width={5}>
                                    {lang.autohostListModalCreatedGamesHeader}
                                </Table.HeaderCell>
                                <Table.HeaderCell width={3}>{lang.autohostListModalOwnerHeader}</Table.HeaderCell>
                                <Table.HeaderCell width={1}>{lang.actions}</Table.HeaderCell>
                            </Table.Row>
                        </Table.Header>
