...
import { AppRuntimeSettingsContext, AuthContext, MapContext, RestContext } from "../../context";
...
function MapEditPage({ updateMap }: MapEditPageProps) {
    ...
    const flagsRequiredAccess = map.owner ? "MAP_FLAGS_EDIT" : "MAP_FLAGS_EDIT_GLOBAL";
    ...
    if (!apiToken.hasAuthority(flagsRequiredAccess) && !apiToken.hasAuthority(externalMapDescriptionAccess)) {
